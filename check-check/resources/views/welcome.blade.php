            ...
            <div class="content">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-4 col-sm-4">
                                    <h2 class="ser-title">Nasze usługi</h2>
                                    <hr class="botm-line">
                            ...
                            <div class="row">
                                <div class="col-md-3 col-sm-4 col-xs-12">
                                    <div class="section-title">
                                      <h2 class="head-title lg-line">Check-check <br>Projekty pod kontrolą</h2>
                                      <hr class="botm-line">
                                      <p class="sec-para">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua..</p>
                                      <a href="" style="color: #0cb8b6; padding-top:10px;">Dowiedz się więcej...</a>
                                    </div>
                                </div>
                                   ...
                                   <div style="visibility: visible;" class="col-sm-9 more-features-box">
                                      <div class="more-features-box-text">
                                        ...
                                        <div class="more-features-box-text-description">
                                            <h3>To ważne. Musisz to wiedzieć</h3>
                        ...
                        <div class="container">
                            <div class=" row">
                                ...
                                <div class="col-md-4 col-sm-5">
                                  ...
                                  <p class="text-right text-primary"><i>— Check- check</i></p>
                                </div>
                                <div class="col-md-2"></div>
                            </div>
                        </div>
                    ...
                    <section id="contact" class="section-padding">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="ser-title">Napisz do nas</h2>
                                    <hr class="botm-line">
                                </div>
                                <div class="col-md-4 col-sm-4">
                                  <h3>Dane kontaktowe i adresowe</h3>
                                  <div class="space"></div>
                                  <p><i class="fa fa-map-marker fa-fw pull-left fa-2x"></i>Piękna ulica 13<br>
                                    Piękniejsze miasto</p>
                                  <div class="space"></div>
                                  <p><i class="fa fa-envelope-o fa-fw pull-left fa-2x"></i>kontakt@checkcheck.pl</p>
                                  <div class="space"></div>
                                  <p><i class="fa fa-phone fa-fw pull-left fa-2x"></i>+48 123 645 789</p>
                                </div>
                                <div class="col-md-8 col-sm-8 marb20">
                                    <div class="contact-info">
                                            <h3 class="cnt-ttl">Masz pytania? Napisz</h3>
                                            <div class="space"></div>
                                            <div id="sendmessage">Twoja wiadomość została wysłana. Dziękujemy!</div>
                                            <div id="errormessage"></div>
                                            <form action="" method="post" role="form" class="contactForm">
                                                <div class="form-group">
                                                    <input type="text" name="name" class="form-control br-radius-zero" id="name" placeholder="Imię" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control br-radius-zero" name="subject" id="subject" placeholder="temat" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" />
                                                    <div class="validation"></div>
                                                </div>
                                                <div class="form-group">
                                                    <textarea class="form-control br-radius-zero" name="message" rows="5" data-rule="required" data-msg="Please write something for us" placeholder="Wiadomość"></textarea>
                                                    <div class="validation"></div>
                                                </div>
